...
export GITHUB_BASE_URL="https://raw.githubusercontent.com/AlivE-git/pterodactyl-installer"
...
curl -sSL -o /tmp/lib.sh https://raw.githubusercontent.com/AlivE-git/pterodactyl-installer/master/lib/lib.sh
